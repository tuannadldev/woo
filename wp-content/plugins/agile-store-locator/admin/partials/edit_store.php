                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <div class="custom-control custom-checkbox">
						...
						<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input" <?php if($store->is_new_store == 1) echo 'checked' ?> name="data[is_new_store]" id="chk_new_Store">
							<label class="custom-control-label" for="chk_new_Store"><?php echo __('Is New Store','asl_admin') ?></label>
						</div>
                    </div>
                  </div>
