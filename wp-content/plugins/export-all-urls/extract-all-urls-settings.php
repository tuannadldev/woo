...
?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <h4 style="float: right;bottom: 0;position: absolute;right: 30px;">Leave <a href="https://wordpress.org/support/plugin/export-all-urls/reviews/?filter=5#new-post" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating!</h4>
                            </td>
        ...
        <div style="padding-bottom: 50px;">
            <h4 style="float:left"><a href="https://wordpress.org/support/plugin/export-all-urls/" target="_blank">Click Here</a> to report a problem OR suggest new feature!</h4>

            <h4 style="float:right">Developed by: <a href="http://AtlasGondal.com/?utm_source=self&utm_medium=wp&utm_campaign=plugin&utm_term=export-url" target="_blank">Atlas Gondal</a></h4>
...
<?php
    ...
    if (isset($_POST['export'])) {
        ...
        if (!empty($_POST['post-type']) && !empty($_POST['export-type']) && !empty($_POST['additional-data']) && !empty($_POST['post-status']) && !empty($_POST['post-author']) && !empty($_POST['number-of-posts']) ) {
            ...
            generate_output($selected_post_type, $post_status, $post_author, $post_per_page, $offset, $export_type, $additional_data, $csv_path, $csv_name, $posts_from, $posts_upto);
