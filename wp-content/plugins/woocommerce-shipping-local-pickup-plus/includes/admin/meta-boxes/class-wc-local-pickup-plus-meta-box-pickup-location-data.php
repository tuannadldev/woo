...
class WC_Local_Pickup_Plus_Meta_Box_Pickup_Location_Data extends \WC_Local_Pickup_Plus_Meta_Box {
	...
	private function output_address_panel() {
		...
		<div id="pickup-location-address" class="panel woocommerce_options_panel">
			...
			<h4><?php esc_html_e( 'Description &amp; Notes', 'woocommerce-shipping-local-pickup-plus' ); ?></h4>
			...
			<?php if ( 'disabled' !== $appointments ) : ?>
				...
				<div class="options_group">
					...
					<p class="form-field">
						...
						<?php echo wc_help_tip( __( 'You can exclude individual days of the year from having a pickup appoint scheduled by a customer who selected this location. This will override the default global public holidays.', 'woocommerce-shipping-local-pickup-plus' ) ); ?>
					</p>
