...
class VTPRD_Controller{
    ...
    if(!isset($_SESSION)){
      ...
      header("Pragma: no-cache");
		...
		define('VTPRD_VERSION',                               '2.0.0.8');
    define('VTPRD_MINIMUM_PRO_VERSION',                   '2.0.0.8'); 
    define('VTPRD_LAST_UPDATE_DATE',                      '2019-04-16');
    ...
    define('VTPRD_ADMIN_JS_FILE_VERSION',                 'v005.min'); //v2.0.0.8 new version  ==> use to FORCE pickup of new JS  
...
*/
  ...
  public function vtprd_check_for_data_updates(){
        ...
        if ( (isset ($vtprd_data_update_options['required_updates']['2.0.0 Rule conversions'])) &&
          ...
          //send msg below, based on this setting...
        }      
        ...
        //*************************
        // ALL MESSAGE PROCESSING FOR UPDATES
