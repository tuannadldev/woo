...
/*
  ...
  Plugin URI: http://codecanyon.net/item/faq-collector-addon-for-product-faq-manager/9992576?ref=xenioushk
...
Class BWL_Wpfm_Fc_Addon {
    ...
    function __construct() {
        ...
        define("BWL_WPFM_FCA_PLUGIN_VERSION", '1.0.8');
    ...
    function wpfm_fca_requirement_admin_notices() {
        ...
        . '<b><a href="http://codecanyon.net/item/woocommerce-product-faq-manager/8011992?ref=xenioushk" target="_blank">WooCommerce Product Faq Manager Plugin</a></b> '
    ...
    function bwpfm_add_custom_product_tab($tabs) {
        ...
        $bwpfm_ask_tab_title = __("Ask A Question", 'bwl-wpfmfc');
...
//        echo apply_filters( 'woocommerce_custom_product_tabs_lite_heading', '', $tab );
