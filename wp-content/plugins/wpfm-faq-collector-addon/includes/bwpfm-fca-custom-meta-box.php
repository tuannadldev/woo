...
function bwpfm_fc_custom_meta_init() {
    ...
    $cmb_bwpfm_fca_fields = array(
        ...
        'meta_box_heading' => __('BWL Woo Product FAQ Settings', 'bwl-wpfmfc'), // That text will be show in meta box head section.
        ...
        'fields' => array(
            'bwpfm_fc_email_send_status' => array(
                'title' => __('Send email to user ', 'bwl-wpfmfc'),
                ...
                'default_value' => 0,
                'class' => 'widefat',
                'desc' => ' ' . __('This data will not store in to database. Select Yes to send a notification message to user about the question.', 'bwl-wpfmfc')
            ),
            'bwpfm_fc_sender_name' => array(
                'title' => __('Sender Name ', 'bwl-wpfmfc'),
                ...
                'default_value' => '-',
                'class' => 'medium',
                'desc' => ' ' . __('You can add/edit sender name in here.', 'bwl-wpfmfc')
            ),
            'bwpfm_fc_user_email' => array(
                'title' => __('Sender Email ', 'bwl-wpfmfc'),
                ...
                'default_value' => '',
                'class' => 'medium',
                'desc' => ' ' . __('You can add/edit sender email in here.', 'bwl-wpfmfc')
            ),
            'bwpfm_fc_date_time' => array(
                'title' => __('Date & Time', 'bwl-wpfmfc'),
    ...
    $cmb_wpfm_fc_display_faq_fields = array(
        ...
        'meta_box_heading' => __('Ask A Question Settings', 'bwl-wpfmfc'), // That text will be show in meta box head section.
        ...
        'fields' => array('wpfm_fc_display_faq' => array(
                'title' => __('Hide Ask A Question Tab? ', 'bwl-wpfmfc'),
...
function bwpfm_fc_updated_send_email($post_id) {
    ...
    if (get_post_status($post_id) == 'publish' && get_post_type($post_id) == 'bwl-woo-faq-manager' &&
        ...
        $subject = __('Product FAQ has been updated!', 'bwl-wpfmfc');
