...
(function ($) {
    ...
    $(function () {
        ...
        if ($(".bwl_fca_ques_form").length) {
            ...
            var $bwl_fca_ques_form_fields = $([]).add($bwl_fca_title)
                    .add($bwl_fca_sender_name)
                    .add($bwl_fca_email)
                    .add($bwl_fca_captcha);
            ...
            if ($bwl_fca_captcha.length === 1) {
                ...
                var $bwl_fca_ques_form_fields = $([]).add($bwl_fca_title).add($bwl_fca_sender_name).add($bwl_fca_email);

            }

            // Initialize All Form Fields.

            $bwl_fca_ques_form_fields.val("");
