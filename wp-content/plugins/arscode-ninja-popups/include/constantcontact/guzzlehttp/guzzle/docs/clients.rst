...
base_url
    ...
    ``https://foo.com``       ``https://baz.com``  ``https://baz.com``
    ``https://foo.com/?bar``  ``bar``             ``https://foo.com/bar``
    =======================  ==================  ===============================

handler
    Configures the `RingPHP handler <https://ringphp.readthedocs.org>`_
...
.. code-block:: php
    ...
    $response = $client->put('https://httpbin.org/get', ['future' => true]);
...
`cURL website <https://curl.haxx.se/docs/sslcerts.html>`_.
