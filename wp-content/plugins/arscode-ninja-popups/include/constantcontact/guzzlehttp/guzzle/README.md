...
[![Build Status](https://secure.travis-ci.org/guzzle/guzzle.svg?branch=master)](https://travis-ci.org/guzzle/guzzle)
...
$req = $client->createRequest('GET', 'https://httpbin.org', ['future' => true]);
