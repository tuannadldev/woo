...
function snp_setup_admin()
{
	...
	$sections[]		 = array(
	    ...
	    'fields' => array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://kb.mailchimp.com/article/where-can-i-find-my-api-key" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_mc_list',
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.getresponse.com/learning-center/glossary/api-key.html" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_gr_list',
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://directmailmac.com/support/article/327" target="_blank">Where do I find my form ID?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_cm_clientid',
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.campaignmonitor.com/api/getting-started/#clientid" target="_blank">Where can I find my Client ID?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_cm_apikey',
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.campaignmonitor.com/api/getting-started/#apikey" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_cm_list',
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://developer.icontact.com/documentation/register-your-app/" target="_blank">Where can I get my App ID?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_ic_apppass',
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://freshmail.com/pomoc-i-wiedza/help/account-settings/what-is-an-api-key-and-where-can-you-find-it" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://help.mailup.com/display/mailupapi/Authenticating+with+OAuth+v2" target="_blank">Where can I find my Client ID?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://support.ontraport.com/entries/26073735-Products-API" target="_blank">Where can I find my API ID?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://dashboard.sendreach.com/customer/index.php/api-keys/index" target="_blank">Where can I find my Public Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.benchmarkemail.com/help-FAQ/answer/How-do-I-access-the-Benchmark-Email-APIs" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.salesautopilot.com/knowledge-base/api/api-key-pairs#.Vi4t_2tFuKI" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://api.myemma.com/#quickstart" target="_blank">Where can I find my account id?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
    		    'id'		 => 'ml_myemma_pubkey',
    		...
    		array(
    		    ...
    		    'sub_desc'	 => __('', 'nhp-opts'),
    		    'desc'		 => __('<a href="https://www.activecampaign.com/help/using-the-api/" target="_blank">Where can I find my API Key?</a>', 'nhp-opts'),
    		    'std'		 => ''
    		),
    		array(
            ...
            array(
                ...
                'sub_desc'   => __('<a href="https://sg-autorepondeur.com/API_V2/DOC/" target="_blank">Where to find "Activation Code"</a>', 'nhp-opts'),
                'std'        => ''
            ),
            array(
	...
	$sections[]		 = array(
		...
		array(
		    ...
		    'desc'	 => __('<a href="https://codecanyon.net/make_money/affiliate_program" target="_blank">Click here for more info</a>', 'nhp-opts'),
		),
		array(
		    'id'		 => 'PROMO_ON',
		    'type'		 => 'checkbox',
	...
	$customfields[]	 = array(
	    ...
	    'fields' => array(
            ...
            array(
                ...
                'desc' => __('(start with https://)', 'nhp-opts')
            ),
	    )
	);
