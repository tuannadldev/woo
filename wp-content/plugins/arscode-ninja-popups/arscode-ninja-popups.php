...
/*
  ...
  Plugin URI: https://codecanyon.net/item/ninja-popups-for-wordpress/3476479?ref=arscode
  Description: Awesome Popups for Your WordPress!
  Version: 4.6.1
  Author: ArsCode
  Author URI: https://www.arscode.pro/
 */
if (!defined('ABSPATH')) {
    die('-1');
}
...
define('SNP_DEMO_LIBRARY_URL', 'https://demo.arscode.pro/ninja-popups/wp-content/uploads/sites/2/ninja-popups/');
...
define('SNP_PROMO_LINK', 'https://codecanyon.net/item/ninja-popups-for-wordpress/3476479?ref=');
DEFINE('SNP_API_URL', 'https://updates.arscode.pro/');
