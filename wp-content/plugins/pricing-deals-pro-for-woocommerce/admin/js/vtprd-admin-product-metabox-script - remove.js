        ...
        jQuery(document).ready(function($) {                                                        
            ...
            //Include or Exclude Area
            
            //1st screen display only
            includeOrExclude_chg();
                                        
            //Product metabox test
            $('#includeOrExclude').change(function(){
                includeOrExclude_chg();                                                   
            });                                     
             function includeOrExclude_chg() {     
              switch( $("#includeOrExclude").val() ) {                                
                case "includeAll":   ruleList_protect();  break;                                                               
                case "includeList":  ruleList_unprotect();  break;
                case "excludeList":  ruleList_unprotect();  break;
                case "excludeAll":   ruleList_protect();  break;                                                          
              };
            };
            function ruleList_protect() { 
            ...
            function ruleList_unprotect() { 
              $('.inOrEx-list-checkbox-class').attr('disabled', false);  
              $('.inOrEx-list-checkbox-label').css('color', '#333333');
              $('#includeOrExclude-title').css('color', '#464646');   
            };            
