...
// 	register_setting( 'http-security', 'http_security_pkp_reportonly_flag' );
	...
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_autoplay' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_autoplay_origin' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_camera' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_document_domain' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_encrypted_media' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_fullscreen' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_geolocation' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_microphone' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_midi' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_payment' );
	register_setting( 'http-security-feature-policy', 'http_security_feature_policy_vr' );
