...
if (!is_user_logged_in()) {?>
    <div class="signin-wrapper" style="background-image:url('<?php echo get_field('background_image', 'option');?>')">
        <div class="login-form-container row content-row mb-0">
            <h3 class="signin-text">Lấy lại mật khẩu</h3>
          <?php
          // Success actions.
          ...
          ?>
            <form id="forgotpassword" method="post" class="woocommerce-form woocommerce-form-login custom-login custom-forgot" action="<?php echo site_url('/wp-forgot-password.php'); ?>">
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <input type="submit" onclick="forgotPassword();return false;" name="get--submit" id="get-code-submit" class="Button Button--primary" value="Lấy mã xác nhận">
                </p>
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
...
<!--                    <a class="forgot-pass-link" href="--><?php //echo home_url('/forgot-password/');?><!--">Quên mật khẩu?</a>-->
            ...
            <div class="register-link">
                Quay lại <a rel="nofollow" href="<?php echo home_url('/signin/');?>">Đăng nhập </a>
            </div>
  </div>
    </div>
  <?php
